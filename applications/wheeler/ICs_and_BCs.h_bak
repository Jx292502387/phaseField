...
void generalizedProblem<dim>::setBCs()
{
  ...
  // Face numbering: starts at zero with the minimum of the first direction, one for the maximum of the first direction, two for the minimum of the second direction, etc.
